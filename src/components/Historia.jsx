...
import { Hammer, Sparkles } from "lucide-react"; // Importamos unos íconos lindos para el estado de construcción
...
export default function Historia() {
  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center bg-white dark:bg-[#0D1F2A] px-6 text-center transition-colors duration-300">
      ...
      <h2 className="text-4xl sm:text-5xl font-black text-proyecta-navy dark:text-white mb-4 font-display">
        Nuestra historia se está{" "}
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-proyecta-cyan to-proyecta-yellow">
          escribiendo...
        </span>
      </h2>

      <p className="max-w-xl text-lg text-proyecta-navy/70 dark:text-white/70 leading-relaxed">
        Estamos desempolvando los archivos y buscando las mejores fotos para
        armar nuestra línea de tiempo. ¡Vuelve pronto para viajar al pasado con
        nosotros! 🕰️💛
      </p>
    </div>
  );
  ...
  /* ==========================================================================
     ...
     Para reactivarlo, borra el 'return' de arriba y quita los comentarios /* */
