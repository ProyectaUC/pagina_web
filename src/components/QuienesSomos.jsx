      ...
      <div className="section-container">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          {pillars.map((p, i) => {
            ...
            return (
              ...
              >
                {/* Icon */}
                <div className={`inline-flex p-4 rounded-2xl ${p.bg} mb-5 group-hover:scale-110 transition-transform duration-300`}>
                  <div className={`bg-gradient-to-br ${p.color} rounded-xl p-2`}>
        ...
        >
          <div
            ...
            style={{ background: 'linear-gradient(135deg, #1B3A4B 0%, #1B5E7A 100%)' }}
          >
            <h3
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
              {valores.map((v, i) => {
                ...
                return (
                  ...
                  >
                    <Icon size={28} className={`${v.color} group-hover:scale-110 transition-transform`} strokeWidth={1.5} />
                    <span className="text-xs font-bold text-white/80 text-center">{v.label}</span>
                  </div>
                )
              })}
            </div>
