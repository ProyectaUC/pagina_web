...
export default function Hero() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(160deg, #1B3A4B 0%, #1B5E7A 55%, #1B9AB5 100%)",
      }}
    >
      ...
      <div className="section-container relative z-10 pt-24 pb-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            ...
            >
              {content.org.description} Lorem ipsum dolor sit amet, consectetur
            ...
            >
              {[
                ...
                <div key={s.label}>
                  ...
                  <div className="text-xs text-white/50 mt-0.5 font-medium">
                    {s.label}
                  </div>
                </div>
              ))}
          ...
          >
            <div className="relative">
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle, #40D0F0 0%, transparent 70%)",
                  transform: "scale(1.5)",
                }}
              />
              {/* ================================================
              ...
              <img
                ...
                style={{
                  filter: "drop-shadow(0 0 40px rgba(64, 208, 240, 0.4))",
                }}
              />
            </div>
          </div>
