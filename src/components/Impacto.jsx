...
const stats = [
  ...
  },
  {
    ...
    bg: "from-proyecta-sky/20 to-proyecta-cyan/10",
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        {/* Decorative dot */}
        <div
          className={`w-2 h-2 rounded-full ${stat.color.replace("text-", "bg-")} animate-pulse-slow`}
        />
      </div>
...
export default function Impacto({ variant = "full" }) {
  const [ref, isVisible] = useInView({ threshold: 0.1 });
  const isCompact = variant === "compact";
  const visibleStats = isCompact ? stats.slice(0, 3) : stats;
      ...
      <div className="section-container relative z-10">
        ...
        >
          ...
          <p className="text-white/60 max-w-xl mx-auto text-lg">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cada cifra
            representa vidas y comunidades transformadas.
          </p>
        </div>

        {/* Stats grid */}
        <div
          className={`grid sm:grid-cols-2 ${isCompact ? "lg:grid-cols-3" : "lg:grid-cols-3 xl:grid-cols-5"} gap-5 mb-12`}
        >
              ...
              {[
                {
                  label: "Personas ayudadas",
                  pct: 72,
                  color: "bg-proyecta-cyan",
                },
                {
                  label: "Voluntarios capacitados",
                  pct: 58,
                  color: "bg-proyecta-yellow",
                },
                {
                  label: "Fondos recaudados",
                  pct: 45,
                  color: "bg-proyecta-orange",
                },
                {
                  label: "Operativos completados",
                  pct: 83,
                  color: "bg-proyecta-teal",
                },
                {
                  label: "Comunidades alcanzadas",
                  pct: 60,
                  color: "bg-proyecta-sky",
                },
                {
