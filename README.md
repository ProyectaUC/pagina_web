...
Las fotos de cada comunidad viven en `public/assets/comunidades/<Nombre Año>/`, referenciadas desde
`communities.ts`. Algunas carpetas todavía repiten el nombre dos veces
(`Buin 2010/Buin 2010/...`) — quedó así de cómo se descomprimió el material original; aplanarlo es
un cambio pendiente que toca ~80 rutas en `communities.ts`, hacerlo con cuidado y verificando que
ninguna foto quede rota.
